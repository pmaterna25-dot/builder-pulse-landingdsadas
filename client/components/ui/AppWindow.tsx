...
type Item = { label: string; description: string; link: string; fileName: string; fileId?: string; color?: 'green' | 'blue' | 'amber'; selectedSlots?: ('left'|'mid'|'right')[]; umowaWystepujacaPrzy?: boolean; umowaDodatkowaLuxmed?: boolean };
